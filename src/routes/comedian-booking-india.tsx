...
const data = CATEGORY_BY_SLUG["comedian-booking-india"]!;
const SITE_URL = "https://tkctalent.com";
const PAGE_URL = `${SITE_URL}/comedian-booking-india`;

export const Route = createFileRoute("/comedian-booking-india")({
  head: () => ({
    meta: [
      { title: data.title },
