...
const data = CATEGORY_BY_SLUG["pan-india-celebrity-booking"]!;
const SITE_URL = "https://tkctalent.com";
const PAGE_URL = `${SITE_URL}/pan-india-celebrity-booking`;

export const Route = createFileRoute("/pan-india-celebrity-booking")({
  head: () => ({
    meta: [
      { title: data.title },
