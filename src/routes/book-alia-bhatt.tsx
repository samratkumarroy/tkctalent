...
import a1 from "@/assets/alia/alia-1.webp";
import a2 from "@/assets/alia/alia-2.webp";
import a4 from "@/assets/alia/alia-4.webp";
import a5 from "@/assets/alia/alia-5.webp";
import a6 from "@/assets/alia/alia-6.webp";
import a7 from "@/assets/alia/alia-7.webp";
import a8 from "@/assets/alia/alia-8.webp";
import deepikaImg from "@/assets/celebrities/deepika-padukone.webp";

const SITE_URL = "https://tkctalent.com";
const PAGE_URL = `${SITE_URL}/book-alia-bhatt`;
const HERO = a4;
const THUMB = a1;
const INLINE_1 = a2;
const INLINE_2 = a8;
...
const slides = [
  { src: a1, caption: "Editorial Portrait" },
  { src: a2, caption: "Brand Campaign" },
  { src: a4, caption: "Met Gala — Red Carpet" },
  { src: a5, caption: "Magazine Cover" },
  { src: a6, caption: "Film Promotion" },
  { src: a7, caption: "Public Appearance" },
  { src: a8, caption: "Luxury Endorsement" },
];

const reasons = [
  { title: "Mass Appeal Across Generations", body: "Alia Bhatt's films and campaigns resonate equally with Gen-Z, millennials and family audiences — a rare cross-demographic profile that few Indian celebrities match." },
  { title: "Versatile Performer", body: "From Highway and Udta Punjab to Gully Boy and Gangubai Kathiawadi, Alia's range makes her brief-friendly: she can anchor a glamorous brand launch or an emotional product story with equal authenticity." },
  { title: "75M+ Instagram Reach", body: "An Alia Bhatt event appearance or post produces organic social amplification far beyond the room — a single post regularly outperforms most national digital campaigns." },
  { title: "Premium Brand Portfolio", body: "Active brand partnerships span L'Oréal Paris, Christian Dior, Jio, Maybelline and Make My Trip — a portfolio that signals trust to luxury, beauty and lifestyle brands alike." },
  { title: "International Crossover", body: "Hollywood debut in Heart of Stone (Netflix) and global Dior ambassadorship make her a natural fit for international and NRI events." },
  { title: "Discreet, Professional Conduct", body: "Alia is among the most punctual, prepared and event-ready celebrities in the industry — TKC Talent has executed multiple appearances without a single hitch." },
];

const events = [
  { icon: "💍", title: "Luxury Weddings & Sangeet", body: "Alia Bhatt brings instant glamour to high-profile wedding receptions and sangeet evenings — including dance sets, choreographed entries and meet-&-greet moments. Available across Delhi NCR, Mumbai, Jaipur, Udaipur, Goa and international destination weddings." },
  { icon: "🏢", title: "Corporate Events & Annual Days", body: "A natural keynote presence and live-stage performer for corporate galas, annual days, leadership summits and dealer conferences." },
  { icon: "🎯", title: "Brand Launches & Campaigns", body: "Single-campaign and annual ambassador contracts across luxury, beauty, fashion, FMCG and lifestyle. Alia's brand affinity drives measurable lift in awareness and intent." },
  { icon: "🎬", title: "Movie Promotions & Premieres", body: "On-stage promotional appearances, OTT premieres and city-tour event coverage for production houses and OTT platforms." },
  { icon: "👗", title: "Fashion Weeks & Showstopper Roles", body: "Showstopper walks for designer launches at Lakmé Fashion Week, India Couture Week and luxury maison previews." },
  { icon: "🌍", title: "International & NRI Events", body: "Global brand activations, NRI community events and Indian-origin festivals — TKC Talent manages international logistics, visas and on-ground execution end-to-end." },
];
...
const steps = [
  ...
  { n: "02", title: "We Negotiate & Confirm", body: "TKC Talent contacts Alia Bhatt's management directly, confirms availability and returns a fully itemised proposal — artist fee, riders, travel, hospitality and security — with no hidden markups." },
...
const fees = [
  { event: "Wedding / Private Celebration (30–60 min)", fee: "₹2 Cr – ₹2.5 Cr+", lead: "90–120 days" },
  { event: "Wedding / Private Celebration (60–90 min)", fee: "₹2.5 Cr – ₹3.5 Cr+", lead: "120+ days" },
  { event: "Corporate Event / Conference Appearance", fee: "₹2 Cr – ₹2.5 Cr", lead: "60–90 days" },
  { event: "Brand Launch / Product Activation", fee: "₹2.5 Cr – ₹3.5 Cr+", lead: "90–120 days" },
  { event: "Brand Endorsement (Annual Campaign)", fee: "₹15 Cr – ₹25 Cr+ / year", lead: "6–12 months" },
  { event: "Brand Endorsement (Single Campaign)", fee: "₹5 Cr – ₹10 Cr+", lead: "3–6 months" },
  { event: "Fashion Week Showstopper", fee: "₹1.5 Cr – ₹2.5 Cr", lead: "60–90 days" },
  { event: "International Appearance", fee: "₹3 Cr – ₹4 Cr+ + intl. logistics", lead: "120+ days" },
];

const included = [
  { icon: "📋", title: "Initial Availability Check", body: "We contact Alia Bhatt's management team immediately upon receiving your brief — confirmation typically within 24 hours." },
  { icon: "💼", title: "Commercial Negotiation", body: "We negotiate the full commercial package — artist fee, deliverables, exclusivity clauses and content rights — drawing on our long-standing management relationships." },
  ...
  { icon: "🏨", title: "5-Star Hospitality", body: "Suite-level hotel accommodation for Alia and core entourage, F&B per rider, and check-in/check-out coordination." },
...
const faqs = [
  { q: "How much does it cost to book Alia Bhatt in 2026?", a: "Alia Bhatt's appearance fee for events in India ranges from approximately ₹2 Crore to ₹3.5 Crore per appearance, exclusive of GST (18%), travel, hospitality and technical riders. Brand endorsement fees range from ₹5 Crore for a single campaign to ₹15–25 Crore+ for annual contracts. TKC Talent provides a fully itemised quote within 30 minutes of receiving your brief." },
  { q: "How to book Alia Bhatt for a wedding?", a: "To book Alia Bhatt for your wedding, contact TKC Talent with your event date, location, expected guest count and approximate budget. Our team checks availability, prepares a commercial proposal and manages the full booking process — from signed contract to on-day coordination. All wedding bookings are managed under a signed confidentiality agreement. Book at least 90–120 days in advance, 6+ months during peak wedding season." },
  { q: "Does Alia Bhatt attend private events and sangeet nights?", a: "Yes. Alia Bhatt does appear at private events including luxury wedding receptions, sangeet nights and HNI private celebrations — subject to schedule availability and a signed NDA. TKC Talent manages all logistics, rider requirements and event-day coordination." },
  { q: "How far in advance do I need to book Alia Bhatt?", a: "We recommend booking Alia Bhatt a minimum of 90–120 days in advance for events in India. For peak wedding season (October to February), 6 months advance planning is strongly advised. For brand endorsement contracts, the process typically begins 6–12 months before campaign launch." },
  { q: "Does TKC Talent have a direct relationship with Alia Bhatt's management?", a: "Yes. TKC Talent, a division of The Kabir Company, has spent over 20 years building direct relationships with the management teams of India's top celebrities. We do not route enquiries through aggregator platforms — our team contacts management directly, which means faster confirmations and better-negotiated fees." },
  { q: "Can I book Alia Bhatt for an international event?", a: "Yes. TKC Talent manages international Alia Bhatt appearances for events in the UAE, UK, USA, Singapore and other destinations with significant Indian diaspora communities. International fees start from ₹3 Crore and above, plus international logistics, security, visa coordination and hospitality." },
  { q: "What does TKC Talent manage when booking Alia Bhatt?", a: "TKC Talent manages the full end-to-end booking process: availability confirmation, commercial negotiation, legal contracts and artist riders, GST-compliant invoicing, business class travel, 5-star hotel accommodation, personal security coordination, green room setup and a dedicated on-ground TKC coordinator from 4 hours before arrival until departure." },
  { q: "Can Alia Bhatt walk as a showstopper at fashion week?", a: "Yes. Alia Bhatt has walked as showstopper for premier designers at Lakmé Fashion Week, India Couture Week and luxury maison previews. TKC Talent manages designer brief alignment, fitting schedules, run-of-show and on-day coordination." },
];

const related = [
  { name: "Kareena Kapoor Khan", category: "Bollywood Actress — A-List", fee: "₹1.5 Cr – ₹3 Cr+", img: "/actresses/kareena-kapoor.png", slug: "/book-kareena-kapoor" as const },
  ...
  "@graph": [
    {
      "@type": "Person",
      name: "Alia Bhatt",
      description: "Indian actress, producer and Hollywood crossover star. Among Bollywood's most awarded young actresses with films like Gangubai Kathiawadi, Gully Boy and Raazi.",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 4, name: "Book Alia Bhatt", item: PAGE_URL },
      ],
    },
  ],
};

export const Route = createFileRoute("/book-alia-bhatt")({
  head: () => ({
    meta: [
      { title: "Book Alia Bhatt for Events in India — Fee & Booking | TKC Talent" },
      { name: "description", content: "Book Alia Bhatt for weddings, brand launches and corporate events. TKC Talent offers direct access, verified 2026 fees & end-to-end execution. Quote in 30 minutes." },
      { name: "keywords", content: "book Alia Bhatt, Alia Bhatt booking fee, Alia Bhatt for wedding, Alia Bhatt brand endorsement, hire Alia Bhatt India, Alia Bhatt appearance fee" },
      { property: "og:title", content: "Book Alia Bhatt for Your Event | TKC Talent" },
      { property: "og:description", content: "Direct access to Alia Bhatt for weddings, brand launches & corporate events. Transparent 2026 fees and full execution." },
      { property: "og:url", content: PAGE_URL },
      { property: "og:type", content: "profile" },
      { property: "og:image", content: `${SITE_URL}${HERO}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Book Alia Bhatt for Your Event | TKC Talent" },
    ...
    scripts: [{ type: "application/ld+json", children: JSON.stringify(validateJsonLd("/book-alia-bhatt", jsonLd)) }],
  }),
  component: BookAliaPage,
});

function BookAliaPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
      <section className="relative overflow-hidden border-b border-foreground/10">
        ...
        <div className="relative z-[1] px-5 pb-12 pt-28 sm:px-10 sm:pb-24 sm:pt-40">
          <nav className="mb-8 overflow-x-auto whitespace-nowrap text-[10px] uppercase tracking-[0.2em] text-foreground/50 sm:text-xs" aria-label="Breadcrumb">
            ...
            <span className="mx-2 text-foreground/30">/</span>
            <span className="text-foreground/80">Book Alia Bhatt</span>
          </nav>
          ...
          <div className="grid grid-cols-12 gap-8 lg:gap-10">
            <div className="col-span-12 lg:col-span-7">
              ...
              <h1 className="font-display text-[clamp(1.75rem,7vw,4.5rem)] font-bold leading-[1.02]">
                Book <span className="bg-brand/30 px-2">Alia Bhatt</span>{" "}
                <span className="italic text-foreground/60">for Your Event</span> — Weddings, Brand Launches & Corporate Galas
              </h1>
              <p className="mt-6 max-w-2xl text-sm leading-relaxed text-foreground/70 sm:text-lg">
                Alia Bhatt — one of Bollywood's most awarded young actresses, a Dior global ambassador and a 75-million-strong social presence. From a private sangeet under the stars to a flagship brand launch in Mumbai, an Alia Bhatt appearance turns the moment into a headline.
              </p>
              <p className="mt-4 max-w-2xl text-xs leading-relaxed text-foreground/60 sm:text-base">
                TKC Talent, a division of The Kabir Company, provides direct access to Alia Bhatt's management for event appearances, brand endorsements and private celebrations across India and internationally — handling every step end-to-end.
              </p>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <a href="https://wa.me/919599599699?text=Hi%2C%20I%27d%20like%20to%20enquire%20about%20booking%20Alia%20Bhatt" target="_blank" rel="noopener" className="inline-flex h-12 min-h-[44px] items-center justify-center rounded-full bg-foreground px-6 text-sm font-medium text-background transition-opacity hover:opacity-90">Get a Quote on WhatsApp →</a>
            ...
            <div className="col-span-12 lg:col-span-5">
              <div className="overflow-hidden rounded-2xl border border-foreground/10 bg-foreground/5">
                <img src={THUMB} alt="Alia Bhatt — Bollywood actress booking via TKC Talent" loading="eager" className="aspect-[4/5] w-full object-cover" />
              </div>
            </div>
          </div>
        </div>
      ...
      <Actress3DCarousel slides={slides} name="Alia Bhatt" headingId="alia-gallery-heading" heading="Alia Bhatt — In Frame" />
      ...
      <section className="px-5 py-14 sm:px-10 sm:py-28">
        ...
        <h2 className="max-w-4xl font-display text-[clamp(1.5rem,5vw,3.25rem)] font-bold leading-[1.05]">About Alia Bhatt — Bollywood's Awarded Young Star</h2>
        <div className="mt-8 grid grid-cols-12 gap-6 sm:mt-10 sm:gap-8">
          <div className="col-span-12 lg:col-span-7 space-y-4 text-sm leading-relaxed text-foreground/75 sm:space-y-5 sm:text-lg">
            <p>Alia Bhatt debuted with <em>Student of the Year</em> in 2012 and rapidly built a body of work that spans <em>Highway</em>, <em>2 States</em>, <em>Udta Punjab</em>, <em>Raazi</em>, <em>Gully Boy</em>, <em>Gangubai Kathiawadi</em> and <em>Rocky Aur Rani Kii Prem Kahaani</em> — collecting six Filmfare Awards and a National Film Award for Best Actress along the way.</p>
            <p>She made her Hollywood debut alongside Gal Gadot in Netflix's <em>Heart of Stone</em> (2023) and was appointed Christian Dior's first Indian global ambassador the same year — a pairing that cemented her position as India's most internationally credible young actress.</p>
            <p>As a brand ambassador, Alia Bhatt represents L'Oréal Paris, Dior, Maybelline, Jio, Make My Trip, Nykaa and many more — a portfolio that signals trust to luxury, beauty, fashion and lifestyle brands alike.</p>
          </div>
          <div className="col-span-12 lg:col-span-5 space-y-4">
            <div className="rounded-2xl bg-foreground p-5 text-background sm:p-7">
              ...
              <ul className="mt-4 space-y-2.5 text-sm sm:mt-5 sm:space-y-3">
                <li>📅  Career: 2012 – Present</li>
                <li>🎬  Films: 25+ Bollywood & Hollywood crossover</li>
                <li>🏆  6 Filmfare + National Film Award (Best Actress)</li>
                <li>📱  Instagram: 75M+ followers</li>
                <li>👗  First Indian global ambassador for Dior</li>
                <li>🌍  Crossover: Netflix's Heart of Stone (2023)</li>
              </ul>
            </div>
            <div className="rounded-2xl border-2 border-brand bg-brand/10 p-5 sm:p-7">
              ...
              <ul className="mt-4 space-y-2.5 text-sm text-foreground/85 sm:mt-5 sm:space-y-3">
                <li>👜  Christian Dior — Global Ambassador</li>
                <li>💄  L'Oréal Paris, Maybelline, Nykaa</li>
                <li>📱  Reliance Jio, Make My Trip</li>
                <li>📊  Forbes India Celebrity 100 — consistent</li>
                <li>🎯  20+ active brand endorsements</li>
                <li>🎤  Live events: command 5,000+ guest crowds</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-foreground/10 px-5 py-14 sm:px-10 sm:py-28">
        <p className="mb-5 text-[10px] uppercase tracking-[0.2em] text-foreground/50 sm:text-xs">03 · Why Brands Love Alia</p>
        <h2 className="max-w-4xl font-display text-[clamp(1.5rem,5vw,3.25rem)] font-bold leading-[1.05]">Why Brands & Event Hosts Choose Alia Bhatt</h2>
      ...
      <section aria-hidden="true" className="relative h-[60vh] min-h-[360px] overflow-hidden border-t border-foreground/10 sm:h-[80vh]">
        <img src={INLINE_1} alt="" loading="lazy" decoding="async" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="absolute inset-x-0 bottom-0 px-5 pb-10 sm:px-10 sm:pb-16">
          ...
          <p className="mt-2 max-w-xl font-display text-xl italic leading-snug text-foreground sm:text-3xl">
            "An evening turned into a headline — Alia's presence rewrites the room."
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-foreground/10 px-5 py-14 sm:px-10 sm:py-28">
        ...
        <h2 className="max-w-4xl font-display text-[clamp(1.5rem,5vw,3.25rem)] font-bold leading-[1.05]">What Events Can Alia Bhatt Headline?</h2>
      ...
      <section id="book" className="border-t border-foreground/10 px-5 py-14 sm:px-10 sm:py-28">
        ...
        <h2 className="max-w-4xl font-display text-[clamp(1.5rem,5vw,3.25rem)] font-bold leading-[1.05]">How to Book Alia Bhatt — 3 Steps with TKC Talent</h2>
      ...
      <section className="border-t border-foreground/10 px-5 py-14 sm:px-10 sm:py-28">
        ...
        <h2 className="max-w-4xl font-display text-[clamp(1.5rem,5vw,3.25rem)] font-bold leading-[1.05]">Alia Bhatt Booking Fee — Indicative Pricing for 2026</h2>
        ...
        <p className="mt-5 max-w-3xl text-sm text-foreground/60">Rule of thumb: budget 25–35% above the base artist fee for the full cost stack (travel, hospitality, security, riders, GST). TKC Talent does not charge hidden markups.</p>
      </section>
      ...
      <section aria-hidden="true" className="relative h-[55vh] min-h-[340px] overflow-hidden border-t border-foreground/10 sm:h-[75vh]">
        ...
        <div className="absolute inset-x-0 top-0 px-5 pt-10 sm:px-10 sm:pt-14">
          <p className="text-[10px] uppercase tracking-[0.3em] text-background/80 sm:text-xs">Brand Campaign</p>
          <p className="mt-2 max-w-xl font-display text-xl font-semibold leading-snug text-background sm:text-3xl">
            India's most awarded young actress — your stage, your campaign.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-foreground/10 px-5 py-14 sm:px-10 sm:py-28">
        ...
        <h2 className="max-w-4xl font-display text-[clamp(1.5rem,5vw,3.25rem)] font-bold leading-[1.05]">Alia Bhatt — Key Event Requirements</h2>
        <div className="mt-8">
      ...
      <section className="border-t border-foreground/10 px-5 py-14 sm:px-10 sm:py-28">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-4">
            ...
            <h2 className="font-display text-[clamp(1.5rem,5.5vw,3.5rem)] font-bold leading-[1.05]">Alia Bhatt Booking — Frequently Asked Questions</h2>
          </div>
          ...
          {related.map((r) => (
            <Link key={r.name} to={r.slug} className="group overflow-hidden rounded-2xl border border-foreground/10 bg-background transition-colors hover:bg-foreground/[0.04]">
              <div className="aspect-[4/5] overflow-hidden bg-foreground/5">
                <img src={r.img} alt={`${r.name} — alternative to Alia Bhatt`} loading="lazy" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" />
              </div>
      ...
      <section className="border-t border-foreground/10 bg-brand px-5 py-14 text-brand-foreground sm:px-10 sm:py-28">
        ...
        <h2 className="max-w-4xl font-display text-[clamp(1.6rem,5.5vw,4rem)] font-bold leading-[1.05]">Book Alia Bhatt for Your Event — Quote in 30 Minutes</h2>
        <div className="mt-8 grid grid-cols-1 gap-4 sm:mt-10 sm:grid-cols-3 sm:gap-6">
          ...
          <a href="https://wa.me/919599599699?text=Hi%2C%20I%27d%20like%20to%20book%20Alia%20Bhatt" target="_blank" rel="noopener" className="rounded-2xl border border-brand-foreground/20 p-5 transition-colors hover:bg-brand-foreground/10 sm:p-7">
          ...
          <a href="mailto:hello@tkctalent.com?subject=Alia%20Bhatt%20booking%20enquiry" className="rounded-2xl border border-brand-foreground/20 p-5 transition-colors hover:bg-brand-foreground/10 sm:p-7">
