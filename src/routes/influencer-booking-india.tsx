...
const data = CATEGORY_BY_SLUG["influencer-booking-india"]!;
const SITE_URL = "https://tkctalent.com";
const PAGE_URL = `${SITE_URL}/influencer-booking-india`;

export const Route = createFileRoute("/influencer-booking-india")({
  head: () => ({
    meta: [
      { title: data.title },
