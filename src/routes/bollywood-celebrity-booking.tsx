...
const data = CATEGORY_BY_SLUG["bollywood-celebrity-booking"]!;
const SITE_URL = "https://tkctalent.com";
const PAGE_URL = `${SITE_URL}/bollywood-celebrity-booking`;

export const Route = createFileRoute("/bollywood-celebrity-booking")({
  head: () => ({
    meta: [
      { title: data.title },
